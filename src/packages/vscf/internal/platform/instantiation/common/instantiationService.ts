...
import { IdleValue } from 'vscf/internal/base/common/async.ts';
import { Event } from 'vscf/internal/base/common/event.ts';
import { illegalState } from 'vscf/internal/base/common/errors.ts';
import { toDisposable } from 'vscf/internal/base/common/lifecycle.ts';
import {
  SyncDescriptor,
  SyncDescriptor0,
} from 'vscf/internal/platform/instantiation/common/descriptors.ts';
import { Graph } from 'vscf/internal/platform/instantiation/common/graph.ts';
import {
...
import { ServiceCollection } from 'vscf/internal/platform/instantiation/common/serviceCollection.ts';
import { LinkedList } from 'vscf/internal/base/common/linkedList.ts';
