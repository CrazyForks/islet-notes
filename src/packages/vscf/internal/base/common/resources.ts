...
import { CharCode } from 'vscf/internal/base/common/charCode.ts';
import * as extpath from 'vscf/internal/base/common/extpath.ts';
import { Schemas } from 'vscf/internal/base/common/network.ts';
import * as paths from 'vscf/internal/base/common/path.ts';
import { isLinux, isWindows } from 'vscf/internal/base/common/platform.ts';
import { compare as strCompare, equalsIgnoreCase } from 'vscf/internal/base/common/strings.ts';
import { URI, uriToFsPath } from 'vscf/internal/base/common/uri.ts';
