...
import { isAbsolute, join, normalize, posix, sep } from 'vscf/internal/base/common/path.ts';
import { isWindows } from 'vscf/internal/base/common/platform.ts';
import {
  equalsIgnoreCase,
  rtrim,
  startsWithIgnoreCase,
} from 'vscf/internal/base/common/strings.ts';
import { isNumber } from 'vscf/internal/base/common/types.ts';
