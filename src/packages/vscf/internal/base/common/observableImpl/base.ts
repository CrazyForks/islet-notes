...
import { IDisposable } from 'vscf/internal/base/common/lifecycle.ts';
import type { derived } from 'vscf/internal/base/common/observableImpl/derived.ts';
...
export interface ISettableObservable<T, TChange = void>
  extends IObservable<T, TChange>, ISettable<T, TChange> {}
