...
} from 'vscf/internal/base/common/cancellation.ts';
import { CancellationError } from 'vscf/internal/base/common/errors.ts';
import { Emitter, Event } from 'vscf/internal/base/common/event.ts';
import {
  Disposable,
  IDisposable,
  MutableDisposable,
...
import { extUri as defaultExtUri, IExtUri } from 'vscf/internal/base/common/resources.ts';
import { URI } from 'vscf/internal/base/common/uri.ts';
import { setTimeout0 } from 'vscf/internal/base/common/platform.ts';
import { MicrotaskDelay } from './symbols.ts';
