...
import { LRUCachedFunction } from 'vscf/internal/base/common/cache.ts';
import { CharCode } from 'vscf/internal/base/common/charCode.ts';
import { Lazy } from 'vscf/internal/base/common/lazy.ts';
import { Constants } from 'vscf/internal/base/common/uint.ts';
