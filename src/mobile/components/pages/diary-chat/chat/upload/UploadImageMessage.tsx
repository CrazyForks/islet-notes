...
export function UploadImageMessage({ task }: { task: AttachmentUploadTaskRecord }) {
  ...
  return (
    <div className={styles.UploadImageMessage.Root} data-test-id={DiaryChat.uploadMessage}>
      <div className={failed ? styles.UploadImageMessage.FailedRow : undefined}>
        {failed && (
